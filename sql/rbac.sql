...
CREATE TABLE `system_config` (
  ...
  CONSTRAINT `system_config_ibfk_1` FOREIGN KEY (`creator_id`) REFERENCES `system_userinfo` (`id`),
  CONSTRAINT `system_config_ibfk_3` FOREIGN KEY (`modifier_id`) REFERENCES `system_userinfo` (`id`)
